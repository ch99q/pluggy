...
### 2.13 `completions <shell>` — ❌ not implemented

Commander has no built-in completions subcommand. Re-adding would require `tabtab` or hand-rolled scripts for bash, zsh, fish, pwsh.
